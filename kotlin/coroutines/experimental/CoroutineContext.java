...
public interface CoroutineContext {
    ...
    public static final class DefaultImpls {
        @NotNull
        public static CoroutineContext plus(@NotNull CoroutineContext coroutineContext, CoroutineContext coroutineContext2) {
    ...
    public interface Element extends CoroutineContext {
        ...
        public static final class DefaultImpls {
            @NotNull
            public static CoroutineContext plus(@NotNull Element element, CoroutineContext coroutineContext) {
            ...
            @Nullable
            public static <E extends Element> E get(@NotNull Element element, Key<E> key) {
            ...
            public static <R> R fold(Element element, @NotNull R r, Function2<? super R, ? super Element, ? extends R> function2) {
                Intrinsics.checkParameterIsNotNull(function2, "operation");
                return (R) function2.invoke(r, element);
            }

            @NotNull
            public static CoroutineContext minusKey(@NotNull Element element, Key<?> key) {
                Intrinsics.checkParameterIsNotNull(key, "key");
