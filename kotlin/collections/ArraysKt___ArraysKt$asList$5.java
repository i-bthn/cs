...
public final class ArraysKt___ArraysKt$asList$5 extends AbstractList<Float> implements RandomAccess {
    ...
    public boolean contains(float f) {
        return ArraysKt.contains(this.receiver$0, f);
    }
    ...
    public int indexOf(float f) {
        return ArraysKt.indexOf(this.receiver$0, f);
    }

    public int lastIndexOf(float f) {
        return ArraysKt.lastIndexOf(this.receiver$0, f);
    }
}
