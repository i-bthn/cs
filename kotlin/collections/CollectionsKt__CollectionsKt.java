...
class CollectionsKt__CollectionsKt {
    ...
    public static final <T> Object[] copyToArrayOfAny$CollectionsKt__CollectionsKt(@NotNull T[] tArr, boolean z) {
    ...
    public static /* bridge */ /* synthetic */ int binarySearchBy$default(List list, Comparable comparable, int i, int i2, Function1 function1, int i3, Object obj) {
        if ((i3 & 2) != 0) {
            i = 0;
        }
        if ((i3 & 4) != 0) {
