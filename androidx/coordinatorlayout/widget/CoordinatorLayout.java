            ...
            if (view.getVisibility() == 8) {
                ...
                if (layoutParams2.keyline < 0 || mode == 0) {
                    ...
                    if ((absoluteGravity == 3 && !z) || (absoluteGravity == 5 && z)) {
                        ...
                        int max = Math.max(i9, i12 + view.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
                        int max2 = Math.max(i11, i13 + view.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                        i14 = max;
                        ...
                        onMeasureChild(view, i8, i6, i7, 0);
                        int max3 = Math.max(i9, i12 + view.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
                        int max22 = Math.max(i11, i13 + view.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                        i14 = max3;
                        i16 = View.combineMeasuredStates(i10, view.getMeasuredState());
                        i15 = max22;
                    }
                ...
                onMeasureChild(view, i8, i6, i7, 0);
                int max32 = Math.max(i9, i12 + view.getMeasuredWidth() + layoutParams.leftMargin + layoutParams.rightMargin);
                int max222 = Math.max(i11, i13 + view.getMeasuredHeight() + layoutParams.topMargin + layoutParams.bottomMargin);
                i14 = max32;
                i16 = View.combineMeasuredStates(i10, view.getMeasuredState());
                i15 = max222;
            }
