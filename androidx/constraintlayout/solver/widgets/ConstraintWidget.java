...
public class ConstraintWidget {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:128:0x0233, code lost:
        if (r1 == -1) goto L_0x0237;
     */
    /* JADX WARNING: Removed duplicated region for block: B:141:0x025f  */
    /* JADX WARNING: Removed duplicated region for block: B:150:0x02c7  */
    /* JADX WARNING: Removed duplicated region for block: B:153:0x02d8 A[RETURN] */
    ...
    /* JADX WARNING: Removed duplicated region for block: B:184:0x0357  */
    /* JADX WARNING: Removed duplicated region for block: B:187:0x038e  */
    /* JADX WARNING: Removed duplicated region for block: B:191:0x03b7  */
    /* JADX WARNING: Removed duplicated region for block: B:194:0x03c1  */
    ...
    public void addToSolver(LinearSystem linearSystem) {
        ...
        if (constraintWidget3 != null) {
            z4 = constraintWidget3 != null && constraintWidget3.mListDimensionBehaviors[0] == DimensionBehaviour.WRAP_CONTENT;
            ConstraintWidget constraintWidget4 = this.mParent;
            boolean z9 = constraintWidget4 != null && constraintWidget4.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT;
            ...
            boolean z10 = (this.mLeft.mTarget != null && this.mLeft.mTarget.mTarget == this.mLeft) || (this.mRight.mTarget != null && this.mRight.mTarget.mTarget == this.mRight);
            ...
            boolean z11 = (this.mTop.mTarget != null && this.mTop.mTarget.mTarget == this.mTop) || (this.mBottom.mTarget != null && this.mBottom.mTarget.mTarget == this.mBottom);
        ...
        iArr[1] = i3;
        if (z5) {
            int i14 = this.mResolvedDimensionRatioSide;
            if (i14 != 0) {
            }
            z6 = true;
            ...
            if (constraintWidget.mVerticalResolution == 2) {
                boolean z16 = constraintWidget.mListDimensionBehaviors[1] == DimensionBehaviour.WRAP_CONTENT && (constraintWidget instanceof ConstraintWidgetContainer);
                boolean z17 = z5 && ((i5 = constraintWidget.mResolvedDimensionRatioSide) == 1 || i5 == -1);
                if (constraintWidget.mBaselineDistance <= 0) {
                    ...
                    if (constraintWidget.mBaseline.mTarget != null) {
                        linearSystem2.addEquality(solverVariable3, linearSystem2.createObjectVariable(constraintWidget.mBaseline.mTarget), 0, 6);
                        z8 = false;
                        ConstraintWidget constraintWidget7 = constraintWidget.mParent;
                        SolverVariable createObjectVariable7 = constraintWidget7 == null ? linearSystem2.createObjectVariable(constraintWidget7.mBottom) : null;
                        ConstraintWidget constraintWidget8 = constraintWidget.mParent;
                        applyConstraints(linearSystem, z7, constraintWidget8 == null ? linearSystem2.createObjectVariable(constraintWidget8.mTop) : null, createObjectVariable7, constraintWidget.mListDimensionBehaviors[1], z16, constraintWidget.mTop, constraintWidget.mBottom, constraintWidget.mY, i, constraintWidget.mMinHeight, constraintWidget.mMaxDimension[1], constraintWidget.mVerticalBiasPercent, z17, z, i3, constraintWidget.mMatchConstraintMinHeight, constraintWidget.mMatchConstraintMaxHeight, constraintWidget.mMatchConstraintPercentHeight, z8);
                        if (!z5) {
                            constraintWidget2 = this;
                            if (constraintWidget2.mResolvedDimensionRatioSide == 1) {
                                linearSystem.addRatio(solverVariable5, solverVariable6, solverVariable4, createObjectVariable, constraintWidget2.mResolvedDimensionRatio, 6);
                            } else {
                                linearSystem.addRatio(solverVariable4, createObjectVariable, solverVariable5, solverVariable6, constraintWidget2.mResolvedDimensionRatio, 6);
                            }
                        } else {
                            constraintWidget2 = this;
                        }
                ...
                z8 = z15;
                ConstraintWidget constraintWidget72 = constraintWidget.mParent;
                if (constraintWidget72 == null) {
                }
                ConstraintWidget constraintWidget82 = constraintWidget.mParent;
                applyConstraints(linearSystem, z7, constraintWidget82 == null ? linearSystem2.createObjectVariable(constraintWidget82.mTop) : null, createObjectVariable7, constraintWidget.mListDimensionBehaviors[1], z16, constraintWidget.mTop, constraintWidget.mBottom, constraintWidget.mY, i, constraintWidget.mMinHeight, constraintWidget.mMaxDimension[1], constraintWidget.mVerticalBiasPercent, z17, z, i3, constraintWidget.mMatchConstraintMinHeight, constraintWidget.mMatchConstraintMaxHeight, constraintWidget.mMatchConstraintPercentHeight, z8);
                if (!z5) {
                }
                if (!constraintWidget2.mCenter.isConnected()) {
                }
    ...
    private void applyConstraints(LinearSystem linearSystem, boolean z, SolverVariable solverVariable, SolverVariable solverVariable2, DimensionBehaviour dimensionBehaviour, boolean z2, ConstraintAnchor constraintAnchor, ConstraintAnchor constraintAnchor2, int i, int i2, int i3, int i4, float f, boolean z3, boolean z4, int i5, int i6, int i7, float f2, boolean z5) {
        ...
        if (!z6) {
            if (z2) {
                ...
                if (i4 < Integer.MAX_VALUE) {
                    linearSystem.addLowerThan(createObjectVariable2, createObjectVariable, i4, i23);
                }
            } else {
            ...
            if (i18 > 0) {
                if (z) {
                    i20 = 1;
                    linearSystem.addLowerThan(createObjectVariable2, createObjectVariable, i18, 1);
                } else {
                    i20 = 1;
                    linearSystem.addLowerThan(createObjectVariable2, createObjectVariable, i18, i19);
                }
                i8 = Math.min(i8, i18);
            } else {
                i20 = 1;
            ...
            if (i25 == i20) {
                if (z) {
                    linearSystem.addEquality(createObjectVariable2, createObjectVariable, i8, i19);
                    i9 = i25;
                    i12 = i18;
                    i10 = i24;
                    solverVariable5 = createObjectVariable3;
                    ...
                    linearSystem.addEquality(createObjectVariable2, createObjectVariable, i8, i20);
                    i9 = i25;
                    i12 = i18;
                    i10 = i24;
                    solverVariable5 = createObjectVariable3;
                ...
                if (z10 || i10 == 2 || z3) {
                    ...
                    linearSystem.addEquality(createObjectVariable2, createObjectVariable, max, i22);
                    z6 = false;
                }
            } else {
                i9 = i25;
        ...
        if (z5 && !z4) {
                    ...
                    if (!isConnected && isConnected2) {
                        ...
                        if (z6) {
                            ...
                            if (i9 == 0) {
                                ...
                                linearSystem.addEquality(createObjectVariable, solverVariable7, constraintAnchor.getMargin(), i17);
                                linearSystem.addEquality(createObjectVariable2, solverVariable4, -constraintAnchor2.getMargin(), i17);
                                z7 = z9;
                                z8 = i12 > 0 || i11 > 0;
                                i14 = 5;
                            } else {
                                ...
                                if (i9 == 1) {
                                    ...
                                    if (!z3) {
                                        if (this.mResolvedDimensionRatioSide != -1 && i12 <= 0) {
                                            i16 = 6;
                                            linearSystem.addEquality(createObjectVariable, solverVariable7, constraintAnchor.getMargin(), i16);
                                            linearSystem.addEquality(createObjectVariable2, solverVariable4, -constraintAnchor2.getMargin(), i16);
                                            i14 = 5;
                                            z7 = true;
                                        }
                                    }
                            ...
                            z8 = true;
                            if (z) {
                                linearSystem.addGreaterThan(createObjectVariable, solverVariable7, constraintAnchor.getMargin(), 5);
                                linearSystem.addLowerThan(createObjectVariable2, solverVariable4, -constraintAnchor2.getMargin(), 5);
                            }
                            i14 = 5;
                            z7 = false;
                        }
                        if (z8) {
                            ...
                            linearSystem.addCentering(createObjectVariable, solverVariable7, constraintAnchor.getMargin(), f, solverVariable4, createObjectVariable2, constraintAnchor2.getMargin(), i14);
                        } else {
                            solverVariable9 = solverVariable7;
                            solverVariable8 = createObjectVariable2;
                            i15 = 6;
                        ...
                        if (z7) {
                            linearSystem.addGreaterThan(createObjectVariable, solverVariable9, constraintAnchor.getMargin(), i15);
                            solverVariable6 = solverVariable8;
                            linearSystem.addLowerThan(solverVariable6, solverVariable4, -constraintAnchor2.getMargin(), i15);
                        } else {
                            solverVariable6 = solverVariable8;
                        }
                        if (z) {
                            i13 = 0;
                            linearSystem.addGreaterThan(createObjectVariable, solverVariable, 0, i15);
                        } else {
                            i13 = 0;
                        }
                    }
            ...
            if (z) {
                linearSystem.addGreaterThan(solverVariable2, solverVariable6, i13, 6);
            }
        } else if (i10 < 2 && z) {
