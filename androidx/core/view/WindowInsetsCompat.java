...
public class WindowInsetsCompat {
    ...
    public boolean hasInsets() {
        return !getInsets(Type.all()).equals(Insets.NONE) || !getInsetsIgnoringVisibility(Type.all()).equals(Insets.NONE) || getDisplayCutout() != null;
    }
    ...
    public static class Impl20 extends Impl {
                    ...
                    switch (i) {
                        ...
                        case 2:
                            ...
                            if (stableInsets2 != null) {
                                i2 = Math.min(i2, stableInsets2.bottom);
                            }
        ...
        private static void logReflectionError(Exception exc) {
            Log.e(WindowInsetsCompat.TAG, "Failed to get visible insets. (Reflection error). " + exc.getMessage(), exc);
        }
