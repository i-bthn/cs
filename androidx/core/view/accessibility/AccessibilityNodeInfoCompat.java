...
public class AccessibilityNodeInfoCompat {
    ...
    public static class AccessibilityActionCompat {
        ...
        static {
            ...
            ACTION_PRESS_AND_HOLD = new AccessibilityActionCompat(accessibilityAction5, 16908362, null, null, null);
            if (Build.VERSION.SDK_INT >= 30) {
                accessibilityAction6 = AccessibilityNodeInfo.AccessibilityAction.ACTION_IME_ENTER;
            }
            ACTION_IME_ENTER = new AccessibilityActionCompat(accessibilityAction6, 16908372, null, null, null);
        }
            ...
            if (cls2 != null) {
                try {
                    ...
                    try {
                        ...
                        Log.e(TAG, "Failed to execute command with argument class ViewCommandArgument: " + str, e);
