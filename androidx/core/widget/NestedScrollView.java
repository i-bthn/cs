            ...
            case 2:
                ...
                if (findPointerIndex != -1) {
                    ...
                    if (this.mIsBeingDragged || Math.abs(i4) <= this.mTouchSlop) {
                        ...
                        this.mIsBeingDragged = true;
                        i = i4 > 0 ? i4 - this.mTouchSlop : i4 + this.mTouchSlop;
                    }
                    if (this.mIsBeingDragged) {
                        ...
                        if (z2) {
                            ...
                            int i8 = scrollY + i7;
                            if (i8 < 0) {
                                EdgeEffectCompat.onPull(this.mEdgeGlowTop, ((float) i7) / ((float) getHeight()), motionEvent.getX(findPointerIndex) / ((float) getWidth()));
                                if (!this.mEdgeGlowBottom.isFinished()) {
                                    this.mEdgeGlowBottom.onRelease();
                                }
                            } else if (i8 > scrollRange) {
                                EdgeEffectCompat.onPull(this.mEdgeGlowBottom, ((float) i7) / ((float) getHeight()), 1.0f - (motionEvent.getX(findPointerIndex) / ((float) getWidth())));
