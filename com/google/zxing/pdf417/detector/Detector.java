    ...
    private static ResultPoint[] findRowsWithPattern(BitMatrix bitMatrix, int i, int i2, int i3, int i4, int[] iArr) {
        ...
        while (true) {
            ...
            if (findGuardPattern != null) {
                ...
                while (true) {
                    ...
                    i7--;
                    int[] findGuardPattern2 = findGuardPattern(bitMatrix, i4, i7, i2, false, iArr, iArr2);
        ...
        if (z) {
            ...
            while (true) {
                ...
                i6 = i10;
                int[] findGuardPattern3 = findGuardPattern(bitMatrix, iArr4[0], i9, i2, false, iArr, iArr2);
