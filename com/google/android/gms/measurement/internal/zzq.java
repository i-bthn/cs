...
public final class zzq extends AbstractSafeParcelable {
    ...
    zzq(@SafeParcelable.Param(id = 2) String str, @SafeParcelable.Param(id = 3) String str2, @SafeParcelable.Param(id = 4) zzjn zzjn, @SafeParcelable.Param(id = 5) long j, @SafeParcelable.Param(id = 6) boolean z, @SafeParcelable.Param(id = 7) String str3, @SafeParcelable.Param(id = 8) zzai zzai, @SafeParcelable.Param(id = 9) long j2, @SafeParcelable.Param(id = 10) zzai zzai2, @SafeParcelable.Param(id = 11) long j3, @SafeParcelable.Param(id = 12) zzai zzai3) {
