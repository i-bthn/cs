...
public final class zzil {
    ...
    public final int zzta() throws IOException {
        ...
        int i = zztf & ByteCompanionObject.MAX_VALUE;
        byte zztf2 = zztf();
        if (zztf2 >= 0) {
            return i | (zztf2 << 7);
        }
        int i2 = i | ((zztf2 & ByteCompanionObject.MAX_VALUE) << 7);
        byte zztf3 = zztf();
        if (zztf3 >= 0) {
            return i2 | (zztf3 << 14);
        }
        int i3 = i2 | ((zztf3 & ByteCompanionObject.MAX_VALUE) << 14);
        byte zztf4 = zztf();
        if (zztf4 >= 0) {
            return i3 | (zztf4 << 21);
        }
        int i4 = i3 | ((zztf4 & ByteCompanionObject.MAX_VALUE) << 21);
        byte zztf5 = zztf();
        int i5 = i4 | (zztf5 << 28);
        if (zztf5 >= 0) {
            return i5;
    ...
    public final <T extends zzey<T, ?>> T zza(zzgr<T> zzgr) throws IOException {
        try {
            ...
            if (zzsx <= i) {
                ...
                T t = (T) ((zzey) this.zzaok.zza(zzgr, zzel.zztq()));
                zzau(this.zzaea);
                return t;
            }
