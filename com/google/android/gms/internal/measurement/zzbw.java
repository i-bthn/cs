...
public final class zzbw extends zziq<zzbw> {
    ...
    public final int zzqy() {
        ...
        if (zzbxArr != null && zzbxArr.length > 0) {
            ...
            while (true) {
                zzbx[] zzbxArr2 = this.zzzn;
                if (i5 >= zzbxArr2.length) {
                    break;
                }
                zzbx zzbx = zzbxArr2[i5];
                if (zzbx != null) {
                    i4 += zzio.zzb(5, zzbx);
                }
                i5++;
    ...
    public final /* synthetic */ zziw zza(zzil zzil) throws IOException {
        while (true) {
            ...
            if (zzsg == 8) {
                ...
                zzbq.zza[] zzaArr2 = new zzbq.zza[(zzb + length)];
                if (length != 0) {
                    System.arraycopy(this.zzzm, 0, zzaArr2, 0, length);
                }
