...
public interface zzim {
    ...
    <K, V> void zza(int i, zzfz<K, V> zzfz, Map<K, V> map) throws IOException;

    void zza(int i, Object obj) throws IOException;

    void zza(int i, Object obj, zzgx zzgx) throws IOException;

    void zza(int i, List<String> list) throws IOException;

    void zza(int i, List<?> list, zzgx zzgx) throws IOException;
    ...
    @Deprecated
    void zzb(int i, Object obj, zzgx zzgx) throws IOException;
    ...
    @Deprecated
    void zzb(int i, List<?> list, zzgx zzgx) throws IOException;
    ...
    @Deprecated
    void zzbr(int i) throws IOException;

    @Deprecated
    void zzbs(int i) throws IOException;
